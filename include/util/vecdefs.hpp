...
inline const vec2d vec2d1 = vec2d::Ones();
inline const vec3d vec3d1 = vec3d::Ones();
inline const vec4d vec4d1 = vec4d::Ones();
inline const vec5d vec5d1 = vec5d::Ones();
inline const vec6d vec6d1 = vec6d::Ones();
inline const vec7d vec7d1 = vec7d::Ones();
inline const vec8d vec8d1 = vec8d::Ones();
inline const vec9d vec9d1 = vec9d::Ones();
inline const vec10d vec10d1 = vec10d::Ones();
inline const vec11d vec11d1 = vec11d::Ones();
inline const vec12d vec12d1 = vec12d::Ones();
...
inline const vec2f vec2f1 = vec2f::Ones();
inline const vec3f vec3f1 = vec3f::Ones();
inline const vec4f vec4f1 = vec4f::Ones();
inline const vec5f vec5f1 = vec5f::Ones();
inline const vec6f vec6f1 = vec6f::Ones();
inline const vec7f vec7f1 = vec7f::Ones();
inline const vec8f vec8f1 = vec8f::Ones();
inline const vec9f vec9f1 = vec9f::Ones();
inline const vec10f vec10f1 = vec10f::Ones();
inline const vec11f vec11f1 = vec11f::Ones();
inline const vec12f vec12f1 = vec12f::Ones();
